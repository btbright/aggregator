			...
			<div className={classes} onClick={this.props.onModalCloseClick}>
				<div className="modal-content">
					...
					<div className="instructions">
						...
						<p>This is a testing release, so things may fall apart at any time. My humblest apologies if/when it does. Please let me know if you have any questions, suggestions, comments, diatribes, etc. I&rsquo;d love hear what you think: <a target='_blank' href='https://twitter.com/aggbuzz'>@aggbuzz</a></p>
						<p>Grey &lt; Green &lt; Blue &lt; Purple &lt; Gold</p>
