			...
			<div className={classes} onClick={this.props.onModalCloseClick}>
				<div className="modal-content">
					...
					<div className="instructions">
						...
						<p>When you click a thing that is already active, you are supporting it in its rise to gold glory, but you can only support one thing at a time. So, pick the best thing. When you are supporting something, its bar will flash and there will be a small dot to its left. The more people support a thing, the higher the bar will go.</p>
