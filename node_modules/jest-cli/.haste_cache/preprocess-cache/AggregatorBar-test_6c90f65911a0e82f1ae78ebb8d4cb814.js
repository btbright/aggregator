'use strict';jest.dontMock('../components/AggregatorBar.jsx');
describe('AggregatorBar', function () {
  it('has the correct elements', function () {
    ...
    React.createElement(AggregatorBar, { 
      rightText: testText, 
      leftText: testText, 
      barValue: 30, 
      residueValue: 50, 
    ...
    console.log(AggregatorBarText);
    expect(AggregatorBarText).toBeCalled(2);});});