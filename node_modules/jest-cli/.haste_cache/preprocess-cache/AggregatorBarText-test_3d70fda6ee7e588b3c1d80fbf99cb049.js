'use strict';jest.dontMock('../components/AggregatorBarText.jsx');
describe('AggregatorBarText', function () {
  it('sets the correct properties', function () {
    var React = require('react');
    var AggregatorBarText = require('../AggregatorBarText.js');
    ...
    React.createElement(AggregatorBarText, { position: testPosition, text: testText }));
